                   ...
                   <div className="collapse navbar-collapse">
                     <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                       <li className="nav-item nav-items">
                         <Link className="nav-link nav-links" to='/bloodbankhome'>
                           Home
                         </Link>
                       </li>
                       <li className="nav-item nav-items">
                       <Link className="nav-link nav-links" to='/acceptorslist'>
                          Acceptors
                         </Link>
                       </li>
                       <li className="nav-item nav-items">
                       <Link className="nav-link nav-links" to='/donarslist'>
                          Donars
                         </Link>
                       </li>
                       <li className="nav-item nav-items">
                       <Link className="nav-link nav-links" to='/appointmentlist'>
                           Appointments
                         </Link>
                       </li>
                     </ul>
